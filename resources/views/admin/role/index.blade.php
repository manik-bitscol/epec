                            ...
                            <tbody>
                                ...
                                @forelse ($roles as $role)
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-success edit-role" data-id="{{ $role->id }}"
                                                data-toggle="modal" data-target="#edit-role"><i
                                                    class="far fa-edit"></i></button>
                                            @includeIf('components.buttons.delete', [
                                                'url' => route('admin.role.delete', $role->id),
                                            ])
                                        </td>
                                    </tr>
                                @empty
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.role.store') }}">
                            ...
                            <div class="form-group">
                                <label for="edit-name" class="form-label">Role<span class="text-danger">*</span></label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.edit-role').on('click', function() {
                ...
                $.get('/admin/role/edit/' + roleId, function(data) {
                    if (data.status == "success") {
                        $('#role').val(data.role.role);
                        $('.update-form').attr('action', "/admin/role/update/" + data.role
                            .id);
                    }
                })
            })
