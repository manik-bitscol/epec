        ...
        <div class="row">
            <div class="col-12 mt-2">
                <div class="heading d-flex justify-content-between">
                    <h3>Team Members</h3>
                    <a href="{{ route('admin.team.create') }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add
                        New</a>
                </div>
                <div class="card mt-2">
                    <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($teams as $team)
                                    <tr>
                                        ...
                                        <td class="w-25"><a
                                                href="{{ route('admin.team.show', $team->id) }}">{{ $team->name }}</a>
                                        </td>
                                        <td class="w-25">{{ $team->designation }}</td>
                                        <td class="w-25"><img class="w-50" src="{{ asset($team->image->url) }}"
                                                alt="">
                                        </td>
                                        <td>
                                            ...
                                            @includeIf('components.buttons.view', [
                                                'url' => route('admin.team.show', $team->id),
                                            ])
                                            @includeIf('components.buttons.delete', [
                                                'url' => route('admin.team.delete', $team->id),
                                            ])
                                        </td>
                                    </tr>
                                @empty
