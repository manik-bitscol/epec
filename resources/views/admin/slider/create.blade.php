                        ...
                        <form action="{{ route('admin.slider.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" required
                                    placeholder="Enter Slider Title" id="title" value="{{ old('title') }}">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="sub_title" required
                                    placeholder="Enter Slider Sub Title" id="sub-title" value="{{ old('sub_title') }}">
                                @error('sub_title')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="btn_text" required
                                    placeholder="Enter Slider Button Text" id="btn-text" value="{{ old('btn_text') }}">
                                @error('btn_text')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="btn_link" required
                                    placeholder="Enter Slider Button Text" id="btn-link" value="{{ old('btn_link') }}">
                                @error('btn_link')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
